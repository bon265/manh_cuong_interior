...
const Footer = () => {
    ...
    return (
        <footer className=" bg-[#364945d1] mt-[65px] text-white text-[20px]">
           <section className=" sm:w-[100%] md:max-w-[1200px]  lg:max-w-[1700px] mx-auto bg-[#7af5dc1c] grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4  p-5" >
            
            <ul className="flex flex-col items-center gap-10 mt-4">
                <h2 className="font-bold text-black">PHẦN CHUNG</h2>
      ...
      <ul className="flex flex-col items-center gap-10 mt-4">
                        <h2 className="font-bold text-black">HỖ TRỢ KHÁCH HÀNG</h2>
        ...
        <li className={liStyle}><Link to="/">những câu hỏi thường gặp</Link></li>
            ...
            <ul >
               ...
               <h2 className="my-10 font-bold text-black">CHỨNG NHẬN</h2>
            ...
            <div className="uppercase mt-4">
                <h2 className="font-bold  text-black">LIÊN HỆ VỚI CHÚNG TÔI</h2>
